            ...
            >
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-4 max-w-4xl mx-auto">
                  ...
                  {/* NOUVEAU BOUTON - Créez et gérez une cagnotte pour un mineur de votre famille */}
                  <Dialog open={showCreateForMinor} onOpenChange={setShowCreateForMinor}>
                    <DialogTrigger asChild>
                      <Button
                        variant="outline"
                        size="lg"
                        className="border-blue-400/60 text-blue-900 hover:bg-blue-100/30 bg-blue-50/60 px-8 py-4 text-xl rounded-full shadow-xl backdrop-blur-sm font-semibold w-full"
                      >
                    ...
                    <DialogContent className="max-w-md">
                      <DialogHeader>
                        <DialogTitle>Créer une cagnotte pour un mineur de votre famille</DialogTitle>
                      </DialogHeader>
                      <div className="space-y-4">
                        ...
                        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                          ...
                          <div className="space-y-2">
                            <Button
                              ...
                              className="w-full bg-black hover:bg-gray-800 text-white flex items-center justify-center gap-2 py-2"
                            >
                        ...
                        {/* Nom du mineur */}
                        <div className="space-y-2">
                          <Label htmlFor="minorName" className="text-sm font-medium">
                            Nom du mineur *
                          </Label>
                          <Input
                            id="minorName"
                            value={minorPotData.minorName}
                            onChange={(e) => setMinorPotData(prev => ({ ...prev, minorName: e.target.value }))}
                        ...
                        {/* Date d'anniversaire */}
                        <div className="space-y-2">
                          <Label htmlFor="minorBirthday" className="text-sm font-medium">
                            Date d'anniversaire *
                          </Label>
                          <Input
                            id="minorBirthday"
                            type="date"
                            value={minorPotData.minorBirthday}
                            onChange={(e) => {
                              setMinorPotData(prev => ({ ...prev, minorBirthday: e.target.value }));
                              validateMinorBirthdayDate(e.target.value);
                            }}
                          />
                          {minorPotError && (
                        ...
                        <Button
                          onClick={handleCreateForMinor}
                          disabled={
                            !minorPotData.minorName || 
                            !minorPotData.minorBirthday || 
                            !!minorPotError
                          }
                          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3"
                        >
                          <UserPlus className="h-5 w-5 mr-2" />
                          Créer la cagnotte pour {minorPotData.minorName || 'ce mineur'}
                        </Button>
                      </div>
                    </DialogContent>
                  </Dialog>
